...
public slots:
    ...
    void printServerInfo() {
        ...
        Logger::instance()->info(QString("TLS Server Port: %1").arg(config_->getServerConfig().port));
        Logger::instance()->info(QString("Database: %1@%2:%3")
                               .arg(config_->getDatabaseConfig().database)
                               .arg(config_->getDatabaseConfig().host)
                               .arg(config_->getDatabaseConfig().port));
